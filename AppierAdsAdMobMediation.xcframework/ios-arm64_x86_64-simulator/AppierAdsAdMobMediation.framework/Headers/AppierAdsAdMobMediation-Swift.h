...
#ifndef APPIERADSADMOBMEDIATION_SWIFT_H
#define APPIERADSADMOBMEDIATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppierAdsAdMobMediation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC23AppierAdsAdMobMediation12APRAdAdapter")
@interface APRAdAdapter : NSObject <GADMediationAdapter>
...
@interface APRAdMobMediation : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) APRAdMobMediation * _Nonnull shared;)
...
SWIFT_CLASS("_TtC23AppierAdsAdMobMediation16APRAdMobNativeAd")
@interface APRAdMobNativeAd : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface APRAdMobNativeAd (SWIFT_EXTENSION(AppierAdsAdMobMediation)) <GADMediationNativeAd>
@property (nonatomic, readonly, copy) NSString * _Nullable headline;
@property (nonatomic, readonly, copy) NSArray<GADNativeAdImage *> * _Nullable images;
@property (nonatomic, readonly, copy) NSString * _Nullable body;
@property (nonatomic, readonly, strong) GADNativeAdImage * _Nullable icon;
...
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nullable extraAssets;
- (BOOL)handlesUserImpressions SWIFT_WARN_UNUSED_RESULT;
- (BOOL)handlesUserClicks SWIFT_WARN_UNUSED_RESULT;
- (void)didRecordImpression;
- (void)didRecordClickOnAssetWithName:(GADNativeAssetIdentifier _Nonnull)assetName view:(UIView * _Nonnull)view viewController:(UIViewController * _Nonnull)viewController;
- (void)didUntrackView:(UIView * _Nullable)view;
@end
